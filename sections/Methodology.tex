...
\begin{figure}
	\centering
	\includegraphics[width=0.4\textwidth]{figures/ConnType_Gauss}
	\label{fig:ConnGauss}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{figures/ConnType_Uniform}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{figures/ConnType_NegExp}
